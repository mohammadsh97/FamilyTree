...
var OrgChartNode = function (parent, boss)
{
	...
	this.getCell(1, 1).setText("Birthday:");
...
OrgChartNode.prototype =
{
	...
	setFields: function()
	{
        ...
        // the employee Birthday is on the second row
		this.getCell(2,1).setText(this.Birthday);
...
$(document).ready(function ()
{
	...
	diagram.addEventListener(Event.enterInplaceEditMode, function (diagram, eventArgs)
	{
		...
		switch (cell)
		{
			...
			case 2:
				// the Birthday
				eventArgs.getControl().setAttribute("placeholder", "Birthday:");
				break;
	...
	ceoNode.setBirthday("00-00-0000");
	ceoNode.setFullName("Edit Preson");
	ceoNode.setImageLocation("");
	//ceoNode.setComment("");
	ceoNode.resize();
		...
		cellEditor.cell.onEdited = function (diagram, tableCell)
		{
			if (edit)
			{
                ...
                if (cellEditor.row == 1 && cellEditor.column == 2)
                 tableNode.Birthday = tableCell.newText;
